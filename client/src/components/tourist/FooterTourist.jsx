      ...
      >
        <div className="grid grid-cols-1 gap-10 text-center md:grid-cols-[1.25fr_0.95fr_0.85fr] md:gap-12 md:text-left">
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="mt-3 max-w-sm text-sm leading-7 text-slate-600 md:max-w-sm">
              Discover authentic destinations, trusted agencies, and memorable
              travel experiences across Nepal with a premium modern journey.
            </p>
          </div>

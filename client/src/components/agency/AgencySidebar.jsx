...
function SidebarItem({ to, icon: Icon, label, end = false, onClick }) {
  return (
...
function SidebarSubItem({ to, label, icon: Icon, onClick }) {
  return (
